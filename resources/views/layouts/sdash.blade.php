...
<!-- Mirrored from themesbrand.com/Studentsapp/layouts/dashboard-saas.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Feb 2022 13:03:19 GMT -->
<head>
        
        <meta charset="utf-8" />
        <title>Saas Dashboard | Studentsapp - Admin & Dashboard Template</title>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Students app.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Design & Develop by Patrick Mwangi
                                </div>
                            </div>
                        </div>
                    </div>
